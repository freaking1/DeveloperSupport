...
if (!isset($_COOKIE['loggedin_user'])) {
	header ("Location:  $secure_site_url/login.php?target=myinfo");
	exit(); 
} 
...
$message = NULL;
		...
		$message = '<font="red"><span class="table01">There was an error getting your data from the database. <br>  Please try again later.</font></span>';
		} 
...
if( $lpquestion && $lpanswer && $fname && $lname& $email && $add1 && $city && $zip && $country && $countrycode && $phone)
		{
$query = "UPDATE users SET lpquestion='$lpquestion', lpanswer='$lpanswer', fname='$fname', lname='$lname', email='$email1', second_email='$email2', add1='$add1', add2='$add2', city='$city', state='$state', province='$province', rspchoice='$rspchoice', zip='$zip', country='$country', countrycode='$countrycode', phone='$phone', fax='$fax', date=NOW(), billing_cardtype='$billingCard_Type', billing_name='$billingname', billing_cc_num='$billingcc_num', billing_exp_month='$billingexp_month', billing_exp_year='$billingexp_year', billing_address='$billingaddress', billing_city='$billingcity', billing_stateprovince='$billingstateprovince', billing_zip='$billingzip', billing_country='$billingcountry', billing_countrycode='$billingcountrycode', billing_phone='$billingphone', billing_cvv2='$cvv2' WHERE id='$user_id'";
	...
	$page = "myaccount";
	$PageTitle = $SiteTitle . " - Change / Update my account information";
	?>
...
<option value="ZW">Zimbabwe</option>			  
  ...
  <p>&nbsp;</p><center><table>
        <tr>
          ...
          <td><center>   <a href="mydomains.php" class="main"><img src="images/btn_cancel.gif" width="74" height="22" border="0" align="left"></a> </center></form>
   </td>
</td>
        </tr>
  </table>
