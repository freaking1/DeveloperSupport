...
if(isset($message)) {echo '<span class="red" align="center">', $message, '</span>';}
if($StepNumber == 4){
				echo '<table width="820" align="center" border="0" class="table00" valign="center">
                      <tr>
                        <td align="center" class="basictext">Create the first user and set the user as the site admin</td>
                      </tr>
					  </table><br>';
					  } ?>
			     </center> </span>
                    ...
                    <div align="center">
<table width="500" height="804" border="0" align="center" cellpadding="0" cellspacing="0" class="tableO1" valign="center">
                        <form method="post" action="install4.php" id="form1" name="form1">
...
<input name="password1" type="password" class="formfield" value="" size="18" maxlength="18">                              </td>
                ...
                (numbers only, no dashes or dots) </td>
                                        ...
                                        <tr>
                                          <td colspan="2" align="center" valign="middle"><input name="image" type="image" src="../images/btn_submit.gif" WIDTH="74" HEIGHT="22" border="0"></td>
                                        </tr>
                                    </table></td>
                                </tr>
                              </table>
