...
//Checks for the form fields
	if (empty($_POST['reguName'])) {
		...
		$reguName = escape_data($_POST['reguName']);
		}
	...
	if(isset($_POST['second_email'])) {
		$email2 = escape_data($_POST['second_email']);
	}
	...
	if(isset($_POST['strStateValue'])) {
		$state = escape_data($_POST['strStateValue']);
	}
...
if( $reguName && $password && $lpquestion && $lpanswer && $fname && $lname& $email && $add1 && $city && $zip && $country && $countrycode && $phone)
{
	...
	$query = "INSERT INTO users (username, password, isadmin, lpquestion, lpanswer, fname, lname, email,  second_email, add1, add2, city, state, province, rspchoice, zip, country, countrycode, phone, fax, date, signup_date)
		VALUES ('$reguName', PASSWORD('$password'), '0', '$lpquestion', '$lpanswer', '$fname', '$lname', '$email', '$second_email', '$add1', '$add2', '$city', '$state', '$province', '$rspchoice', '$zip', '$country', '$countrycode', '$phone', '$fax', NOW(), NOW() )";
	$result = @mysql_query ($query);
	
			include ("include/emails/newuser.php");	
	header ("Location: createsuccess.php");
	exit;
	} else {
	$message .= '<br>That username is already Taken.  Please choose another.</br>';
	}
	mysql_close();
	} 
}
	$PageName= "CreateAccount";
	$PageTitle = $SiteTitle . " - Create a new Account";
?>
...
<table width="964" align="center" valign="center" class="tableOO">
    ...
    <table width="964" height="380" border="0" cellpadding="0" cellspacing="0" class="tableOO" id="table8">
		<tr>
			...
			<table width="100%" height="218" border="0" valign="center" align="center" cellpadding="0" cellspacing="0" class="content" id="table13">
				<tr>
				  <td height="19" colspan="3"  class="titlepic"><span class="whiteheader">Create a New account </span><b>                                 </b></td>
			    </tr>
				<tr>
	...
	if(isset($message)) {echo '<span class=\"red\">', $message, '</span>';}?>
                    ...
                    <div align="center">
                      <table width="500" height="804" border="0" cellpadding="0" cellspacing="0" class="tableO1" valign="center">
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" id="form1" name="form1">
						<input type="hidden" name="action" value="createacct"><tr>
                            <td align="center" class="titlepic"><span class="whiteheader"> Account Information</span></td>
                          </tr>
                          <tr>
                            <td height="214" align="center">
                                <table valign="center" class="gray" cellpadding="0" cellspacing="0" width="100%">
                                  <td height="212" align="center">
                                        <table border="0"  valign="center" cellpadding="2" cellspacing="2" width="100%">
                                            <tr>
                                              <td align="right" valign="top"><br>
                                                  <b class="red">*</b>Username:&nbsp;&nbsp;</td>
                                              <td class="smallblue">                                                  <input name="reguName" type="text" class="formfield" id="reguName" value="<?php if(isset($_POST['reguName'])) echo $_POST['reguName']; ?>" size="18" maxlength="18">                                                  </td>
                                            </tr>
                                            <tr>
...
<input name="password1" type="password" class="formfield" value="" size="18" maxlength="18">                              </td>
                                            ...
                                            <tr>
                                              ...
                                              <td class="smallblue">
                                                ...
                                                <br>
                                              (Used for account verification and password retrieval)</td>
                                            </tr>
                                    </table></td>
                            </table></td>
                          </tr>
                        <td align="center">
                              <table class="gray" cellpadding="0" cellspacing="0" width="100%"><tr>
                                        
                                </tr>
                                </table></td>
                              </tr>
                          <tr>
                            <td align="center">                              <table class="gray" cellpadding="0" cellspacing="0" width="100%"><tr>
                                  <td align="center" height="17" nowrap="nowrap" width="100%" class="titlepic"> <span class="whiteheader">Contact Information</span></td>
                                </tr>
                                <tr>
                                  <td height="507" align="center">
                ...
                (numbers only, no dashes or dots) </td>
                                        ...
                                        <tr>
                                          <td height="23" colspan="2" align="right" valign="top"><div align="center"><span class="red">Note: all required fields have a red star *.</span> </div></td>
                                        </tr>
                                        <tr>
                                          <td colspan="2" align="center" valign="middle"><input name="image" type="image" src="images/btn_submit.gif" WIDTH="74" HEIGHT="22" border="0">
&nbsp;<a href="index.php" class="main"><img src="images/btn_cancel.gif" width="74" height="22" border="0"></a></td>
                          ...
                          <tr>
                            <td height="4" align="center"> <table border="0" cellpadding="2" cellspacing="2"><br>
                                  <p></p>
                                  <tr>
