...
<table width="964" align="center" valign="center" class="tableOO">
    ...
    <table width="964" height="380" border="0" cellpadding="0" cellspacing="0" class="tableOO" id="table8">
		<tr>
			...
			<table width="101%" height="429" border="0" align="center" cellpadding="0" cellspacing="0" class="content" id="table13">
				<tr>
				...
				<tr>
			      <td height="369" colspan="3" valign="top" class="content2">                  
			        <p>&nbsp;</p>
			        <p align="center">This page will be entered once the API commands are written</p>
			      <tr>
	          </table>
</table>
