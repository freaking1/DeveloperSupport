...
<tr> 
	<td class="OutlineOne">
		...
		<form method="post" action="epptransfer.php" id="form1" name="form1">
...
<?
		  ...
		  <tr> 
			...
			<td width="50%" valign="middle" class="row2">&nbsp;&nbsp;&nbsp; <input type="text" name="sld" id="sld2" maxlength="256" value="<?php echo "$sld"; ?>"> 
			  &nbsp;.&nbsp;<?php include ('Setup/tldListTwo.php'); ?></td>
		  ...
		  <tr>
            ...
            <td  class="row1"><b class="red">*</b>Authorization  Key (EPP)    
    (<b class="red">REQUIRED</b>):&nbsp;</td>
            <td valign="middle" class="row2"><b class="red">&nbsp;&nbsp;&nbsp;
                  <input type="text" name="authinfo" id="password22" maxlength="25" value="<?php echo $HTTP_POST_VARS[ "authinfo" ]?>">
            </b></td>
            <td align="center" valign="middle" noWrap class="row2"><img src="images/blank.gif" width="8" height="25" border="0"></td>
	      </tr>
		  <tr>
            <td align="center" valign="middle" class="row1">&nbsp;</td>
