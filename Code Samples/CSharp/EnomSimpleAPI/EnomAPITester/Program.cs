...
namespace Enom.Tools.API.APITester
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //enomApi.Username = "enomtest_reseller";
            //enomApi.Password = "tester";
            
            // Populating Constructor
            EnomAPI enomApi = new EnomAPI("https://resellertest.enom.com/interface.asp?", "enomtest_reseller", "tester", "check");
